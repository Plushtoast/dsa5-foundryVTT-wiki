---
layout: default
title: de-Meister-Menue
---
# Meister Menü
Das Meister Menü bietet Funktionen für den Spielleiter. Es werden alle Akteure vom Typ Spieler angezeigt, die mindestens einem Spieler mit den Rechten *Besitzer* zugeordnet wurden. Danach können diese aber beliebig verschoben oder sogar aus dem Menü entfernt werden.

Ihr findet es auf der linken Seite unter *Meister Menü* -> *Meister Menü*

![Meister Menü öffnen](/dsa5-foundryVTT-wiki/de/images/de-meister-menue_0.webp)
...
8. **Bezahlung erhalten:** Erzeugt ein Chatfenster, über das der eingegebene Betrag (In Silbertalern) vom Spieler zu seinem Charakter hinzugefügt werden kann.  
9. **Ausnehmen:** Erzeugt ein Chatfenster über das der eingegebene Betrag (In Silbertalern) von den Spielern bezahlt werden kann.  
...
13. **Gruppenchips**: Können vom SL über +- für die ganze Gruppe vergeben werden. Diese lassen sich dann im Chat über das Kontextmenü verwenden.
14. **Zuchtgrube**: Wird auf dieser Seite näher beschrieben: [Meister-Menü-Zuchtgrube](/dsa5-foundryVTT-wiki/de/de-Meister-Menue-Zuchtgrube) 
15. **Szeneneinstellungen**: Wird auf dieser Seite näher beschrieben: [Meister-Menü-Szeneneinstellungen](/dsa5-foundryVTT-wiki/de/de-Meister-Menue-Szeneneinstellungen)  

![Meister Menü](/dsa5-foundryVTT-wiki/de/images/de-meister-menue_0.webp)

## Charaktere entfernen/hinzufügen
Um einen Charakter aus dem Menü zu entfernen klickt ihr auf das X hinter dem Char:  
  
  ![MM - Char entfernen](/dsa5-foundryVTT-wiki/de/images/de-meister-menue_1.webp)
