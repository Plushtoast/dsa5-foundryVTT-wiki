...
![Kompendien](/dsa5-foundryVTT-wiki/de/images/de-bibliothek_0.webp)  

## Kompendium erstellen und Bibliothek
Oben in der Leiste befinden sich 2 Buttons:
1. **Kompendium**: Hiermit lassen sich Kompendien zur Ablage eingener Inhalte anlegen. (Siehe [Eigene Inhalte erstellen](/dsa5-foundryVTT-wiki/de/de-Eigene_Inhalte_erstellen))
...
8. **Ergebnisfeld**: Anzeige der Suchergebnisse auf Basis der Suche. Diese Ergebnisse kannst du per Drag and Drop Akteuren hinzufügen oder auf dem Spielfeld platzieren. Drag and Drop über das Münzitem bezahlt dabei gleich den Gegenstand.
...
![Bibliothek](/dsa5-foundryVTT-wiki/de/images/de-bibliothek_1.webp)  
...
1. Drag and Drop: Vieles kann per Drag and Drop direkt ins Spiel gezogen werden. 
  ...
  ![Spezies verwenden](/dsa5-foundryVTT-wiki/de/images/de-bibliothek_2.webp)
  
Importieren: Ihr könnt Objekte aus der Bibliothek importieren um sie dann in eurer Welt zu verändern:  
...
2. Oben rechts befindet sich dann immer ein Symbol um das geöffnete Objekt zu importieren. 
  ...
  ![Eintrag Importieren](/dsa5-foundryVTT-wiki/de/images/de-bibliothek_3.webp)

3. Ihr findet sie dann in unter dem jeweiligen Menüpunkt. Dies ist nützlich zum [Erstellen eigener Inhalte](/dsa5-foundryVTT-wiki/de/de-Eigene_Inhalte_erstellen)  
  
![Importierter Eintrag](/dsa5-foundryVTT-wiki/de/images/de-bibliothek_4.webp)
