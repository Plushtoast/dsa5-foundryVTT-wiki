...
7. "Mit Akteur Verbinden" verbindet den Token mit dem Akteur, sodass zum Beispiel Schaden an den Akteur übertragen wird usw. "Händler" wählt für den NSC automatisch das [NSC-Händler-Sheet](de-haendler#händler) aus.
