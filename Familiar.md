To create a familiar for your witch you have to create a new actor using the creature sheet. Alternatively you can take a predefined animal from the core modul or any other modul (f.e. a cat).
