---
layout: default
title: en-eigene_inhalte_erstellen
---
...
The easiest way is to [import](/dsa5-foundryVTT-wiki/en-bibliothek#use-contents) a template from one of the compendiums.
...
![Ritual Arcanovi](/dsa5-foundryVTT-wiki/images/en-create-personal-entries_0.webp)  
  
2. rewrite the description and the details of the values of the new ritual
  
![Ritual Adamantium](/dsa5-foundryVTT-wiki/images/en-create-personal-entries_1.webp)
...
![Neuer Zauber](/dsa5-foundryVTT-wiki/images/en-create-personal-entries_0.webp)  

*Translation information*  
*[x] updated: 2021-06-07*  
*[x] german entry [linked](/dsa5-foundryVTT-wiki/de/de-Eigene_Inhalte_erstellen)*  
