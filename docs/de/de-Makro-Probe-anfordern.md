---
layout: default
title: de-Makro-Probe-anfordern
---
...
2. Dann schreibt ihr den Code `game.dsa5.macro.requestRoll("TALENT", MODIFIKATOR);` in das *Command*-Feld (Beispiele siehe unten)  
  ...
  ![Makro Probe anfordern](/dsa5-foundryVTT-wiki/de/images/de-makro-probe-anfordern_0.webp)
  
### Beispiele
#### Bekehren & Überzeugen erleichtert um 1
`game.dsa5.macro.requestRoll("Bekehren & Überzeugen", 1);`  
  
![Bekehren & Überzeugen](/dsa5-foundryVTT-wiki/de/images/de-makro-probe-anfordern_1.webp)
  
#### Willenskraft erschwert um 2
`game.dsa5.macro.requestRoll("Willenskraft", -2);`  
  
![Willenskraft](/dsa5-foundryVTT-wiki/de/images/de-makro-probe-anfordern_2.webp)
  
#### Zauber Fulminictus erschwert um 2
`game.dsa5.macro.requestRoll("Fulminictus", -2);`  
  
![Fulminictus](/dsa5-foundryVTT-wiki/de/images/de-makro-probe-anfordern_3.webp)
...
2. Dann schreibt ihr den Code `game.dsa5.macro.requestGC("TALENT", MODIFIKATOR);` in das *Command*-Feld (Beispiel: `game.dsa5.macro.requestGC("Sinnesschärfe", 0);`) 
  ...
  ![Makro Gruppenprobe anfordern](/dsa5-foundryVTT-wiki/de/images/de-makro-probe-anfordern_0.webp)
...
![grafik](/dsa5-foundryVTT-wiki/de/images/de-makro-probe-anfordern_0.webp)  
