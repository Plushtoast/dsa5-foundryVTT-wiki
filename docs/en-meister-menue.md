...
| 14 | **Breeding Pit** | Described in detail: [Breeding Pit](/dsa5-foundryVTT-wiki/en-meister-menue-zuchtgrube) |
| 15 | **Scene Settings** | Described in detail: [Scene Settings](/dsa5-foundryVTT-wiki/en-Meister-Menue-Szeneneinstellungen) |
...
### For All Selected Characters
- **Check All**: Roll the selected talent for all marked characters
- **Pay All**: Distribute payment to all marked characters
- **Collect All**: Collect payment from all marked characters
- **Reward All**: Award AP to all marked characters

### For Individual Characters
Each row has its own set of buttons for that specific character.

## Character Details

Click on a character row to expand and see:
- **Purse**: Current money
- **Experience Level**: Character's experience category
...
### Remove a Character
Click the **X** behind the character to remove them from the menu.

![Remove Character](images/en-meister-menue-remove.webp)

### Add a Character
Drag and drop a character or NPC into the menu. You can also rearrange the order via drag and drop.

## Group Fate Points (Schips)

The GM can manage group fate points that apply to the entire party:
- Click **+** or **-** to adjust group chips
- Players can use these via the context menu in chat
- Useful for shared resources in campaigns

## Tips

- **Quick Access**: Pin the GM Menu for easy access during sessions
- **Secret Rolls**: All rolls from the GM Menu are hidden from players by default
- **Bulk Actions**: Use checkboxes to select multiple characters for bulk operations
- **AP Tracking**: Use with the [AP Tracker](/dsa5-foundryVTT-wiki/en-tracker-ap-geld) for comprehensive tracking

---

**See also:**
- [Scene Settings](/dsa5-foundryVTT-wiki/en-Meister-Menue-Szeneneinstellungen)
- [Breeding Pit](/dsa5-foundryVTT-wiki/en-meister-menue-zuchtgrube)
