---
layout: default
title: en-status-selbst-erstellte-effekte
---
...
* [Effects from Actors](/dsa5-foundryVTT-wiki/en-status-selbst-erstellte-effekte#actor-effects)
* [Effects from a melee weapon (Item](/dsa5-foundryVTT-wiki/en-status-selbst-erstellte-effekte#effect-of-a-melee-weapon-item)  
* [Talent adjustments by effects](/dsa5-foundryVTT-wiki/en-status-selbst-erstellte-effekte#talent-adjustments-by-effects)

Also, here is the description of how to have the duration of effects handled automatically:
* [Effect Duration](/dsa5-foundryVTT-wiki/en-status-selbst-erstellte-effekte#effect-duration)
...
![Effekt hinzufügen](/dsa5-foundryVTT-wiki/images/en-status-self-created-effects_0.webp)
...
4. here you have under attribute key now a selection of common effects
  ...
  ![Liste Effekt](/dsa5-foundryVTT-wiki/images/en-status-self-created-effects_1.webp)
...
![Armatrutz](/dsa5-foundryVTT-wiki/images/en-status-self-created-effects_2.webp)
...
![Item Effekt Magisches Schwert](/dsa5-foundryVTT-wiki/images/en-status-self-created-effects_0.webp)
  
![Transferierte Statuseffekte](/dsa5-foundryVTT-wiki/images/en-status-self-created-effects_1.webp)
...
![Würfelbecher des Glücks](/dsa5-foundryVTT-wiki/images/en-status-self-created-effects_0.webp)
...
3. you have the choice between different options. Most commonly used are *Duration (seconds)* and *Duration (moves) - rounds*.
  ...
  ![Dauer Effekt](/dsa5-foundryVTT-wiki/images/en-status-self-created-effects_0.webp)
...
![Console](/dsa5-foundryVTT-wiki/images/en-status-self-created-effects_0.webp)


*Translation information*  
*[x] updated: 2021-06-07*  
*[x] german entry [linked](/dsa5-foundryVTT-wiki/de/de-Status-Selbst-erstellte-Effekte)*  
