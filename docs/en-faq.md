...
For more details, see the [Character Creation](/dsa5-foundryVTT-wiki/en-charaktererstellung) and the [character sheet](/dsa5-foundryVTT-wiki/en-charakterbogen).
...
Make sure you have the weapons equipped in the equipment tab. You can do that by placing a check mark in the *Shield* column. For details, check out the guide: [Character Sheet - Equipment](/dsa5-foundryVTT-wiki/en-charakterbogen#5-equipment).  

## How can I create tokens that look like from the DSA books?
With the module "Tokenizer". You can find a short how-to in [this section.](/dsa5-foundryVTT-wiki/en-charaktererstellung#11-portrait-and-token)
...
![lock and unlock](/dsa5-foundryVTT-wiki/images/en-faq-01.webp)


*Translation information*  
*[x] updated: 2021-06-10*  
*[x] german entry [linked](/dsa5-foundryVTT-wiki/de/de-FAQ)*  
