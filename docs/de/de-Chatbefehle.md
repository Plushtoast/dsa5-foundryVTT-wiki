...
* Tabellen - `/tables`
* Wurf anfordern - `/rq`
* 3w20 Probe - `/ch` [siehe unten](/dsa5-foundryVTT-wiki/de/de-Chatbefehle#ch-3w20-probe)
* Gruppenprobe - `/gc` [siehe unten](/dsa5-foundryVTT-wiki/de/de-Chatbefehle#gc-gruppenprobe)
* Ausrüstungspakete - `/packages` [siehe unten](/dsa5-foundryVTT-wiki/de/de-Chatbefehle#packages-ausrüstungspakete)  
* Anwendungsgebiete - `/apps` [siehe unten](/dsa5-foundryVTT-wiki/de/de-Chatbefehle#anwendungsgebiete)
* Zufallsnamen - `/nm` [siehe unten](/dsa5-foundryVTT-wiki/de/de-Chatbefehle#zufallsnamen)
* Charakterrechner - `/cc` [siehe unten](/dsa5-foundryVTT-wiki/de/de-Chatbefehle#charakterrechner)
* Hilfe - `/help`
...
2. Es öffnet sich ein Fenster bei dem ihr den Wurf modifizieren können.  
  ...
  ![Chat 3d20 Probe](/dsa5-foundryVTT-wiki/de/images/de-chatbefehle_0.webp)  
...
![3d20 Beispiel](/dsa5-foundryVTT-wiki/de/images/de-chatbefehle_1.webp)  
...
2. Daraufhin erscheint eine Liste aller Fertigkeiten die ihr verwenden könnt. Wählt eine davon aus oder gebt sie direkt ein und schickt den Befehl mit Enter ab.  
  ...
  ![Gruppenprobe]![grafik](/dsa5-foundryVTT-wiki/de/images/de-chatbefehle_2.webp)  
...
Daraufhin erscheint im Chat eine Meldung bei der jeder Spieler der an der Probe teilnehmen möchte, auf die Fertigkeitsprobe klicken und damit an der Gruppenprobe teilnehmen kann.  
  ...
  ![QS Gruppenprobe](/dsa5-foundryVTT-wiki/de/images/de-chatbefehle_3.webp)  
...
3. Speichert mit dem Stift die Änderungen ab.  
  ...
  ![Gruppenprobe modifizieren](/dsa5-foundryVTT-wiki/de/images/de-chatbefehle_4.webp)
...
5. Die einzelnen Items können dann auch per Drag and Drop in den Charakterbogen gezogen werden. 
  ...
  ![Ausrüstungspaket](/dsa5-foundryVTT-wiki/de/images/de-chatbefehle_5.webp)  
...
Über der Befehl /apps erscheint im Chat ein Fenster mit dem alle Anwendungsgebiete auf einmal zu einem Akteuer hinzugefügt werden können. Dafür muss einfach der "Begriff" Anwendungsgebiete aus diesem Chatfenster in den Charakterbogen gezogen werden. 
  ...
  ![Anwendungsgebiete](/dsa5-foundryVTT-wiki/de/images/de-chatbefehle_6.webp)
...
![Zufallsnamen](/dsa5-foundryVTT-wiki/de/images/de-chatbefehle-namen.webp)
