---
layout: default
title: en-charakterbogen
---
# Character Sheet - Structure
The structure of the character sheet is as similar as the sheet of the rulebook.
There are the categories in it:  
1. [Header](/dsa5-foundryVTT-wiki/en-charakterbogen#1-header)  
2. [Skills](/dsa5-foundryVTT-wiki/en-charakterbogen#2-skills)  
3. [Combat](/dsa5-foundryVTT-wiki/en-charakterbogen#3-combat)  
4. [Attributes](/dsa5-foundryVTT-wiki/en-charakterbogen#4-attributes)  
5. [Equipment](/dsa5-foundryVTT-wiki/en-charakterbogen#5-equipment)  
6. [State](/dsa5-foundryVTT-wiki/en-charakterbogen#6-state)  
7. [Notes](/dsa5-foundryVTT-wiki/en-charakterbogen#7-notes)  
8. [Magic](/dsa5-foundryVTT-wiki/en-charakterbogen#8-magic)  
9. [Religion](/dsa5-foundryVTT-wiki/en-charakterbogen#9-religion)  
...
![charsheet overview](/dsa5-foundryVTT-wiki/images/en-charactersheet-01.webp)  

## 1. Header
This part of the sheet is always visible and shows a characters base information. Many values are calculated and derived from the settings in the [Attributes tab](/dsa5-foundryVTT-wiki/en-charakterbogen#4-attributes).  
![charsheet header](/dsa5-foundryVTT-wiki/images/en-charactersheet-02.webp)  
...
- **Profession:** Can be edited. It's text only. See [here](/dsa5-foundryVTT-wiki/en-charaktererstellung#6-choose-profession) for more information on choosing / entering professions.
- **Attribute values:** derived from the [Attributes tab](/dsa5-foundryVTT-wiki/en-charakterbogen#4-attributes), where it can be changed
...
![charsheet skills](/dsa5-foundryVTT-wiki/images/en-charactersheet-06.webp)  
...
7. **Cumulative Checks** You can add a cummulative check for a certain skill here. That way, you can quickly roll several checks and keep track of your collected QL, including critical successes and botches.  
  ![charsheet cumulative01](/dsa5-foundryVTT-wiki/images/en-charactersheet-04.webp)  
  ...
  - Now you can roll with the dice-symbol and it will send the results to the chat (indivdual rolls and a separate message for the accumulated QL and modifiers)  
    ![charsheet cumulative02](/dsa5-foundryVTT-wiki/images/en-charactersheet-05.webp)  


## 3. Combat
The combat sheet contains all data used for [Combat](/dsa5-foundryVTT-wiki/en-kampf) in TDE 5.  
![charsheet combat](/dsa5-foundryVTT-wiki/images/en-charactersheet-07.webp)  

1. **Weapons and Armor**: Lists all weapons and armor that are equipped **and have been marked as "worn"** (=activated for the combat sheet) in the [equipment tab.](/dsa5-foundryVTT-wiki/en-charakterbogen#5-equipment)  
  ...
  **1. b) Ammunition**: here you can select ammunition for the weapon. However, this must be stored in the [Equipment](/dsa5-foundryVTT-wiki/en-charakterbogen#5-equipment). Then the system will automatically reduce the ammunition after an attack.  
...
![attributes](/dsa5-foundryVTT-wiki/images/en-charactersheet-08.webp)
...
1. **Experience level**: Here, the available and spent adventure points are managed. Details about this in the [character creation.](/dsa5-foundryVTT-wiki/en-charaktererstellung). You can always overwrite the existing numbers manually. We strongly recommend to use a external [tool](en-ressources) to keep track of your character and AP, and only mirror the char within Foundry.  
...
To add new items, they can be dragged onto the character sheet from the library. Alternatively, [content can be created.](/dsa5-foundryVTT-wiki/en-eigene_inhalte_erstellen)  
![](/dsa5-foundryVTT-wiki/images/en-charactersheet-09.webp)
...
![state](/dsa5-foundryVTT-wiki/images/en-charactersheet-10.webp)
...
3. **Modifiers**: Shows you different active modifiers, what they influence and where they come from, f.e: advantage "Luck" gives 2 extra fate points to the char.  
  ...
  d) Plus opens a filter to search and select available effects. You can click the PLUS sign in the opening window to [create your own stati](/dsa5-foundryVTT-wiki/en-status-selbst-erstellte-effekte).
...
![context menu](/dsa5-foundryVTT-wiki/images/en-charactersheet-11.webp)
...
![Charakterbogen Notizen](/dsa5-foundryVTT-wiki/images/en-charactersheet_0.webp)
...
3. **Tradition, Leiteigenschaft, Merkmal, Leiteig. Multiplier**: the leadership trait must be specified here, since the AsP in the [Traits](/dsa5-foundryVTT-wiki/en-charakterbogen#4-attributes) are also calculated via it. In addition, the influence of the trait on the astral points can be set via the *trait multiplier* (e.g.: Spellbard 0.5).
4. **Magic tricks** !  
  
![Magie](/dsa5-foundryVTT-wiki/images/en-charactersheet_0.webp)
...
3. **Tradition, Leadership Trait, Aspect, Benevolent Talents**: the Leadership Trait must be specified here, as it is also used to calculate the KaP in the [Traits](/dsa5-foundryVTT-wiki/en-charakterbogen#4-attributes).  
...
![Religion](/dsa5-foundryVTT-wiki/images/en-charactersheet_0.webp)

*Translation information*  
*[x] updated: 2021-06-05*  
*[x] german entry [linked](/dsa5-foundryVTT-wiki/de/de-Charakterbogen)*  
