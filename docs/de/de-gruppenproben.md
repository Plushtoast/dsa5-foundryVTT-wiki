...
> **Hinweis:** Diese Seite beschreibt Gruppenproben, bei denen mehrere Spieler in Echtzeit gemeinsam würfeln. Für erweiterte Proben über einen längeren Zeitraum (z.B. Herstellung) siehe [Sammelproben](/dsa5-foundryVTT-wiki/de/de-aggregate-proben).
...
- [Vergleichende Proben](/dsa5-foundryVTT-wiki/de/de-vergleichende-proben) - Proben gegeneinander
- [Chat-Befehle](/dsa5-foundryVTT-wiki/de/de-Chatbefehle) - Alle verfügbaren Chat-Befehle
- [Meister-Menü](/dsa5-foundryVTT-wiki/de/de-Meister-Menue) - Übersicht über SL-Werkzeuge
