...
Diese Einstellung hängt direkt mit den [Einstellungen am Token](https://github.com/Plushtoast/dsa5-foundryVTT/wiki/de-Sicht_und_Licht#token-einstellungen) zusammen.  
...
### Modultip: Torch
[Das Modul Torch](https://github.com/Plushtoast/dsa5-foundryVTT/wiki/de-Module#torch) bietet die Möglichkeit Fackeln über das Kontextmenü der Token zu aktivieren und deaktivieren.  
...
und steuere die Sicht bei Tag nur über Hindernisse, bei Dunkelheit über Dämmersicht und Fackeln)  
