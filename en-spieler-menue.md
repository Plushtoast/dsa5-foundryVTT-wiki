...
Similar to alchemy, this area supports the creation of weapons, armor, and other items.

- **Process**:
  1. Select craftsman
  2. Drag in blueprint/recipe (weapon/armor)
  3. Select materials and trade secrets (if necessary)
  4. Roll aggregate checks until the required QL are reached

![Crafting in Player Menu](images/en-spieler-menue-crafting.webp)

### 4. Artifacts

(If available) Support for creating magical artifacts (Arcanovi, etc.).

### 5. Character Calculator

A small button (often top right or in the menu) opens the character calculator, which helps calculate advancement costs (AP) or plan attributes.

## Menu Sections Overview

| Section | Purpose |
|---------|---------|
| **Summoning** | Summon elementals and demons |
| **Alchemy** | Brew potions and elixirs |
| **Smithing** | Craft weapons and armor |
| **Herbalism** | Search for plants |
| **Foraging** | Hunt and gather food |
| **Artifacts** | Create magical items |

## Tips

- Many of these functions require the corresponding talents and spells to be present on the character sheet
- **Drag & Drop** is the key to using this menu
- The menu remembers your last active character
- Some functions require premium modules (Compendiums) to be installed
