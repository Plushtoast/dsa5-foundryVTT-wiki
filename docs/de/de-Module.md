...
![Dice Tray](/dsa5-foundryVTT-wiki/de/images/Module_Dice_Tray.webp)

## Dice so nice
Wirf 3D Würfel über den virtuellen Spieltisch. Dabei kann sogar zwischen verschiedenen DSA5 Themen gewählt werden. Mittlerweile gibt es in den [Systemeinstellungen](/dsa5-foundryVTT-wiki/de/de-Systemeinstellungen) auch die Möglichkeit, die Dice-So-Nice-Würfel für die Proben über den Charakterbogen zu verwenden. 
![Dice so nice Wurf](/dsa5-foundryVTT-wiki/de/images/de-module_0.webp)
...
![Dice so nice Einstellungen](/dsa5-foundryVTT-wiki/de/images/de-module_1.webp)
...
![grafik](/dsa5-foundryVTT-wiki/de/images/de-module_2.webp)
...
![Tokenizer](/dsa5-foundryVTT-wiki/de/images/de-module_4.webp)
...
![Automated Animations import](/dsa5-foundryVTT-wiki/de/images/Module_Automated_Animations_import.webp)
...
![Health Estimate](/dsa5-foundryVTT-wiki/de/images/healthestimate.webp)
...
![Splatter](/dsa5-foundryVTT-wiki/de/images/splatter.webp)
