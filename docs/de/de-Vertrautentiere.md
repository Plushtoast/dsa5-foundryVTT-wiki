---
layout: default
title: de-Vertrautentiere
---
## Erstellung eines Vertrautentieres

Um einen Vertrauten anzulegen muss als erstes über neuen Akteur erstellen -> eine *Kreatur* erstellt werden. Alternativ kann eine Kreatur aus einem der offiziellen Modulen importiert werden (Bsp. die Katze).
...
![Vertrauter](/dsa5-foundryVTT-wiki/de/images/de-vertrautentiere_0.webp)
  
**Anmerkung**: Damit der Spieler diesen Vertrauten selbst steuern kann, benötigt er noch die Berechtigung *Besitzer* auf den Akteur.
...
Abenteuerpunkte können über das Meistermenü anteilig an Spieler und Begleiter verteilt werden. Sind die Begleiter im Meistermenü eingetragen, halten sie ebenfalls 10% der AP (bzw. Vertraute 25%).
