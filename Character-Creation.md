...
2. Then you go to the Compendium Packs and select your Species from the compendium Species by dragging it from the compendium to your character sheet  
  
![Race Selection](https://user-images.githubusercontent.com/75448500/106726734-033dfe80-660b-11eb-8b4f-18fc96756306.jpg)
  
 
Note: The Species require you to select a trait, follow the species description screen
...
4. If you want to use a DSA pre generated Profession, select you Profession from the compendium by dragging it to your sheet. Alternatively you can just enter a name of your Profession and continue with the next step.   
...
5. Modify your Attributes and Skill
...
NOTE: at this point in time DSA in foundry does not automatically deduct money from you character when dropping an item to the character sheet. You have to keep track of your spendings manually.
