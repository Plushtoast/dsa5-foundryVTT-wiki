---
layout: default
title: en-meister-menue-sichtautomatisierung
---
# Sight Automation
...
Clicking on Sight Automation in the [GM Menu - Scene Settings](/dsa5-foundryVTT-wiki/en-Meister-Menue-Szeneneinstellungen) leads to a menu with 3 sections:
...
This section corresponds to the [Light Macro](/dsa5-foundryVTT-wiki/en-licht-und-sicht-makro) and is explained there. Important here is that with active automation, the sight values are adjusted based on scene darkness. They therefore no longer correspond 1:1 to what is set in the [Presets](/dsa5-foundryVTT-wiki/en-meister-menue-sichtautomatisierung#presets).
...
6. Default (No Sight): Specifies which value from the [Presets](/dsa5-foundryVTT-wiki/en-meister-menue-sichtautomatisierung#presets) should be used if the actor has no advantage or similar.
...
Some of the points are already explained under [Light and Sight Macro - Presets](/dsa5-foundryVTT-wiki/en-licht-und-sicht-makro#presets), so here only the points important for sight automation.
7. The compensation configuration only appears when the Mode (2) under [Sight Automation](/dsa5-foundryVTT-wiki/en-meister-menue-sichtautomatisierung#sichtautomatisierung) is set to Compensation.
...
**See also:**
- [Light and Sight Macro](/dsa5-foundryVTT-wiki/en-licht-und-sicht-makro)
