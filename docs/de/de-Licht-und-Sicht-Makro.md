---
layout: default
title: de-Licht-und-Sicht-Makro
---
...
Auf das Makro kann zum einen über das Meister Menü ([hier beschrieben](/dsa5-foundryVTT-wiki/de/de-Meister-Menue-Szeneneinstellungen)), aber auch über ein Makro aus dem Grundregelwerk-Kompendium zugegriffen werden.
![Licht und Sicht Makro finden](/dsa5-foundryVTT-wiki/de/images/Licht-und-Sicht-Makro_Makro.webp)  
...
1. Über "Spieler Token auswählen" werden alle sich auf dem Spielfeld befindlichen Spieler-Token ausgewählt, sodass Änderungen für alle gleichzeitig durchgeführt werden.
2. Die "Sicht"-Einstellungen bieten die Möglichkeit, über einen einfachen Klick die Sicht der ausgewählten Token anzupassen. Dabei wird auf die Werte zurückgegriffen, die unter [Presets](/dsa5-foundryVTT-wiki/de/de-Licht-und-Sicht-Makro#presets) definiert wurden.
...
5. Die "Licht"-Einstellungen bieten die Möglichkeit, das Licht der ausgewählten Token schnell anzupassen. Also wenn die Spieler eine Fackel in die Hand nehmen oder einen Flim Flam wirken. Auch hier wird auf die Einstellungen unter [Presets](/dsa5-foundryVTT-wiki/de/de-Licht-und-Sicht-Makro#presets) zurückgegriffen.
...
![Licht und Sicht Makro](/dsa5-foundryVTT-wiki/de/images/Token-Licht-Konfiguration_Sicht.webp)
...
8. Über den Burger-Menü-Button können die Lichter zusätzlich direkt auf eine Szene gezogen werden. Du kannst passende Lichter vorbereiten und so immer wieder verwenden.

![Sicht und Licht Makro - Presets](/dsa5-foundryVTT-wiki/de/images/Licht-und-Sicht-Makro_Presets.webp)
