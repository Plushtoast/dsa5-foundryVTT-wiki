...
1. [Create character (game master)](/dsa5-foundryVTT-wiki/en-charaktererstellung#1-create-character-game-master)  
2. [Enter experience](/dsa5-foundryVTT-wiki/en-charaktererstellung#2-enter-experience)  
3. [Choose species](/dsa5-foundryVTT-wiki/en-charaktererstellung#3-choose-species)  
4. [Choose culture](/dsa5-foundryVTT-wiki/en-charaktererstellung#4-choose-culture)  
5. [Distribute attribute points](/dsa5-foundryVTT-wiki/en-charaktererstellung#5-attribute-points)  
6. [Select Profession](/dsa5-foundryVTT-wiki/en-charaktererstellung#6-choose-profession)  
7. [Choose advantages and disadvantages](/dsa5-foundryVTT-wiki/en-charaktererstellung#7-select-advantages-and-disadvantages)  
8. [Make increases](/dsa5-foundryVTT-wiki/en-charaktererstellung#8-improvements)  
9. [Choose special skills](/dsa5-foundryVTT-wiki/en-charaktererstellung#9-choose-special-abilities)  
10. [Final adjustments (notes, equipment, name)](/dsa5-foundryVTT-wiki/en-charaktererstellung#10-final-adjustments)  
11. [Portrait and token images (game master)](/dsa5-foundryVTT-wiki/en-charaktererstellung#11-portrait-and-token)  
...
### [Using content from the library](/dsa5-foundryVTT-wiki/en-bibliothek)
### [Create your own content (spells, special skills, equipment, etc.)](/dsa5-foundryVTT-wiki/en-eigene_inhalte_erstellen)
...
![Create Actor](/dsa5-foundryVTT-wiki/images/en-character-creation-01.webp)
...
4. save changes  
![Actor permissions](/dsa5-foundryVTT-wiki/images/en-character-creation-02.webp)  
...
![enter ap manually](/dsa5-foundryVTT-wiki/images/en-character-creation-03.webp)  
...
![select ap by exp level](/dsa5-foundryVTT-wiki/images/en-character-creation-04.webp)

## 3. choose species
After the species has been [dragged onto the character sheet](/dsa5-foundryVTT-wiki/en-bibliothek), a window opens with the following tabs/information:
1. **Description**: Information, Flufftext and background information about the species  
![species description](/dsa5-foundryVTT-wiki/images/en-character-creation-05.webp)
...
![species general](/dsa5-foundryVTT-wiki/images/en-character-creation-06.webp)
...
![species dis-advantages](/dsa5-foundryVTT-wiki/images/en-character-creation-07.webp)
...
## 4. choose culture
The culture is also simply dragged onto the character sheet. Tabs and information are similar to the [species](/dsa5-foundryVTT-wiki/en-charaktererstellung#3-choose-species) and the same rules apply.
Differences are:
...
![species culture](/dsa5-foundryVTT-wiki/images/en-character-creation-08.webp)
...
![char-attributes](/dsa5-foundryVTT-wiki/images/en-character-creation-09.webp)
...
![profession](/dsa5-foundryVTT-wiki/images/en-character-creation-10.webp)
...
![char-dis-advantages](/dsa5-foundryVTT-wiki/images/en-character-creation-11.webp)
...
![char-improvements1](/dsa5-foundryVTT-wiki/images/en-character-creation-12.webp)  
![char-improvements2](/dsa5-foundryVTT-wiki/images/en-character-creation-13.webp)  
![char-improvements3](/dsa5-foundryVTT-wiki/images/en-character-creation-14.webp)  
...
* General special abilities, languages, writings, fate point abilities -> Attributes Tab  
  * ![special abilities](/dsa5-foundryVTT-wiki/images/en-character-creation-15.webp) 
* Clerical abilities, traditions -> Religion Tab  
  * ![clerical abilities](/dsa5-foundryVTT-wiki/images/en-character-creation-16.webp)  
* Magic  abilities, traditions -> Magic Tab  


  * ![magic abilities](/dsa5-foundryVTT-wiki/images/en-character-creation-18.webp)   
* Combat abilities -> Combat Tab  
  * ![combat abilities](/dsa5-foundryVTT-wiki/images/en-character-creation-17.webp) 
 ...
 * **Notes** You  can add a Bio, additional notes and stats on the "Notes" Tab. There is a separate field for GM notes, and only players with higher permissions can see them. See [this page](/dsa5-foundryVTT-wiki/en-charakterbogen#5-equipment) for more info on that.
 * **Equipment** You can add single items or packages to your chars inventory. Please check [this page](/dsa5-foundryVTT-wiki/en-charakterbogen#7-notes) for detailed information about that process. Most importantly: If you want to use a weapon or armor, you have to equip it. To do so, tick that little circle in the "worn" column. 
...
![image-basic](/dsa5-foundryVTT-wiki/images/en-character-creation-20.webp)  
...
![image-tokenizer1](/dsa5-foundryVTT-wiki/images/en-character-creation-21.webp)  
![image-tokenizer2](/dsa5-foundryVTT-wiki/images/en-character-creation-22.webp)  
![image-tokenizer3](/dsa5-foundryVTT-wiki/images/en-character-creation-23.webp)  
![image-tokenizer4](/dsa5-foundryVTT-wiki/images/en-character-creation-24.webp)  


*Translation information*  
*[x] updated: 2021-06-09*  
*[x] german entry [linked](/dsa5-foundryVTT-wiki/de/de-Charaktererstellung)*  
