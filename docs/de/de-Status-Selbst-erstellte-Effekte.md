---
layout: default
title: de-Status-Selbst-erstellte-Effekte
---
# Status - Selbst erstellte Effekte
Effekte bieten die Möglichkeit gewisse Charakterwerte zu beeinflussen. Selbst erstellte Effekte sind in verschiedenen Objekten innerhalb von Foundry verfügbar: Charaktere, Zauber, Rituale, Liturgien, Zeremonien, Ausrüstung, usw. Überall da, wo ihr im Fenster des Objektes einen Effekt/Statuseffekte-Tab habt. Vom Grundprinzip funktionieren alle ähnlich, deshalb folgen hier drei Beispiele:  

- [Effekte von Akteuren](/dsa5-foundryVTT-wiki/de/de-Status-Selbst-erstellte-Effekte#effekte-von-akteuren)
- [Effekte von einer Nahkampfwaffe (Item)](/dsa5-foundryVTT-wiki/de/de-Status-Selbst-erstellte-Effekte#effekt-von-einer-nahkampfwaffe-item)
- [Talentanpassungen durch Effekte](/dsa5-foundryVTT-wiki/de/de-Status-Selbst-erstellte-Effekte#talentanpassungen-durch-effekte)
- [Teilprobenmodifikatoren](/dsa5-foundryVTT-wiki/de/de-Status-Selbst-erstellte-Effekte#teilprobenmodifikatoren)

Außerdem findet ihr hier die Beschreibung, wie ihr die Dauer von Effekten automatisch behandeln lassen könnt:  

- [Effektdauer](/dsa5-foundryVTT-wiki/de/de-Status-Selbst-erstellte-Effekte#effektdauer)
...
![Effekt hinzufügen](/dsa5-foundryVTT-wiki/de/images/de-status-selbst-erstellte-effekte_0.webp)

### Auswahlliste der wichtigsten Effekte
Ihr könnt zwischen den wichtigsten Attributen und Eigenschaften aus einer Auswahlliste auswählen:

1. Erstellt einen neuen Effekt
2. Öffnet diesen zur Bearbeitung
3. Im Reiter Effekte einen neuen über das + im Rahmen erstellen
4. Hier habt ihr unter Attributschlüssel jetzt eine Auswahl an gängigen Effekten
  
  ![Liste Effekt](/dsa5-foundryVTT-wiki/de/images/de-status-selbst-erstellte-effekte_1.webp)
...
![Armatrutz](/dsa5-foundryVTT-wiki/de/images/de-status-selbst-erstellte-effekte_2.webp)
...
**Achtung:** in Foundry 0.7.X können die Gegenstandseffekte nicht im Charakter angepasst werden. Hierfür müsst ihr das Item unter Items verändern und wieder in den Charakterbogen ziehen.
...
![Item-Effekt Magisches Schwert](/dsa5-foundryVTT-wiki/de/images/de-status-selbst-erstellte-effekte_3.webp)
  
![Transferierte Statuseffekte](/dsa5-foundryVTT-wiki/de/images/de-status-selbst-erstellte-effekte_4.webp)
...
![Würfelbecher des Glücks](/dsa5-foundryVTT-wiki/de/images/de-status-selbst-erstellte-effekte_5.webp)
...
![Teilprobenmodifikatoren](/dsa5-foundryVTT-wiki/de/images/Selbst_erstellte_Effekte_Teilprobenmodifikatoren.webp)
...
![Dauer Effekt](/dsa5-foundryVTT-wiki/de/images/de-status-selbst-erstellte-effekte_6.webp)
...
![Console](/dsa5-foundryVTT-wiki/de/images/de-status-selbst-erstellte-effekte_7.webp)
