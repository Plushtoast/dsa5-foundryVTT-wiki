...
1. [Kopfbereich](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#1-kopfbereich)
2. [Talente](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#2-talente)
3. [Kampf](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#3-kampf)
4. [Eigenschaften](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#4-eigenschaften)
5. [Ausrüstung](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#5-ausrüstung)
6. [Status](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#6-status)
7. [Notizen](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#7-notizen)
8. [Magie](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#8-magie)
9. [Religion](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#9-religion)
  
**Anmerkung**: Die Punkte [Magie](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#8-magie) und [Religion](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#9-religion) erscheinen nur, wenn dem Charakter mindestens eine magische oder karmale Sonderfertigkeit/Zauber/Ritual/Liturgie/Zeremonie zugeordnet ist. Auch erst dann erscheinen im [Eigenschaftenbogen](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#4-eigenschaften) AsP- und/oder Karmapunkte.
  
![Charakterbogen](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_0.webp)

## 1. Kopfbereich

Dieser Teil des Bogens ist immer sichtbar und wird unter anderem durch die Eingaben in [Eigenschaften](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#4-eigenschaften) beeinflusst. Es handelt sich hier um die aktuellen Werte des Charakters.  
Außerdem kann hier eine Profession eingetragen werden - entweder eine [vorgefertigte Profession](/dsa5-foundryVTT-wiki/de/de-Charaktererstellung#6-profession-wählen), oder die Bezeichnung für eine eigene Profession.  
Oben rechts findet ihr ein paar Schaltflächen für weitere Funktionen:  

1. Steigerungen sperren/entsperren 
2. [Bibliothek](/dsa5-foundryVTT-wiki/de/de-Bibliothek) öffnen 
3. Akteur konfigurieren: Hier findet ihr die [Import Funktion](/dsa5-foundryVTT-wiki/de/de-Import-Funktion) 
4. Blatt konfigurieren: Charakterbogen auswählen - siehe auch [Händler](/dsa5-foundryVTT-wiki/de/de-Haendler)
5. Token konfigurieren: siehe auch [Sicht und Licht - Token Einstellungen](/dsa5-foundryVTT-wiki/de/de-Sicht_und_Licht#token-einstellungen)
  
![Charakterbogen Kopfbereich](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_1.webp)
...
- **Profession:** Kann bearbeitet werden, ist dann aber nur Text. [Hier](/dsa5-foundryVTT-wiki/de/de-Charaktererstellung#6-profession-wählen) gibt es weitere Information zum Hinzufügen einer Profession zum Character.
- **Eigenschaftswerte:** Übertragen vom [Eigenschafts-Tab](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#4-eigenschaften), wo sie verändert werden können.
...
![Charakterbogen Talente](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_2.webp)
...
![Sammelprobe](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_3.webp)
...
![Sammelprobe Chat](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_4.webp)

## 3. Kampf

Der Kampfbogen beinhaltet alle Daten die zum [Kampf](/dsa5-foundryVTT-wiki/de/de-Kampf) in DSA 5 verwendet werden.

1. **Nah-, Fernkampfwaffen und Rüstungen**: Listet alle Waffen und Rüstungen auf, die im Reiter [Ausrüstung](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#5-ausrüstung) vorhanden sind **und ausgerüstet** (=für den Kampfbogen aktiviert) wurden. Dazu muss auf der Ausrüstungs-Seite neben dem Gegenstand ein Haken gesetzt werden, siehe [Ausrüstung](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#5-ausrüstung)
...
![Charakterbogen Kampf](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_5.webp)
...
4. **Erfahrungsgrad**: hier werden die Verfügbaren und Ausgegebenen Abenteuerpunkte verwaltet. Details hierzu in der [Charaktererstellung](/dsa5-foundryVTT-wiki/de/de-Charaktererstellung)
  
![Eigenschaften](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_6.webp)  
...
Um neue Items hinzuzufügen, können diese aus der Bibliothek auf den Charakterbogen gezogen werden. Alternativ können [Inhalte erstellt werden.](/dsa5-foundryVTT-wiki/de/de-Eigene_Inhalte_erstellen)
...
![Charakterbogen Ausrüstung](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_7.webp)
...
3. **Plus (Hinzufügen)**: öffnet ein Kontextmenü, über das ein Status/Zustand gesucht und dem Charakter hinzugefügt werden kann. Zudem lassen sich [eigene Stati anlegen.](/dsa5-foundryVTT-wiki/de/de-Status-Selbst-erstellte-Effekte)
  
![Charakterbogen Status](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_8.webp)  
...
**Kontextmenü**: dieses Menü lässt sich über das + im Charakterbogen-Status oder direkt im Kontextmenü des Tokens öffnen. 
 ...
 - Über das  Symbol im Charaktersheet lassen sich Einträge suchen/filtern, zudem kann man [eigene Einträge erstellen](/dsa5-foundryVTT-wiki/de/de-Status-Selbst-erstellte-Effekte) (+ Symbol neben dem Suchfeld).
  
![Charakterbogen Status Kontextmenü](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_9.webp)  
...
![Charakterbogen Notizen](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_10.webp)
...
3. **Tradition, Leiteigenschaft, Merkmal, Leiteig. Multiplikator**: die Leiteigenschaft muss hier angegeben werden, da sich darüber auch die AsP in den [Eigenschaften](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#4-eigenschaften) berechnen. Außerdem kann über den *Leiteigenschaft Multiplikator* der Einfluss der Leiteigenschaft auf die Astralpunkte eingestellt werden (Bsp: Zauberbarde 0.5).
4. **Zaubertricks**  
  
![Magie](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_11.webp)
...
3. **Tradition, Leiteigenschaft, Aspekt, Wohlgefällige Talente**: die Leiteigenschaft muss hier angegeben werden, da sich darüber auch die KaP in den [Eigenschaften](/dsa5-foundryVTT-wiki/de/de-Charakterbogen#4-eigenschaften) berechnen.  
...
![Religion](/dsa5-foundryVTT-wiki/de/images/de-charakterbogen_12.webp)
